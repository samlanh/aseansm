...
class Registrar_Form_FrmSearchInfor extends Zend_Dojo_Form
{
	...
	public function FrmSearchRegister($data=null){ 
		...
		$opt_session = array(-1=>$this->tr->translate("SESSION"));
		...
		$opt_time = array(-1=>$this->tr->translate("TIME"),
		...
		$opt_grade = array(-1=>$this->tr->translate("GRADE"),
				1=>$this->tr->translate("1"),
				2=>$this->tr->translate("1"),
		);
		$_grade->setMultiOptions($opt_grade);
		...
		$this->addElements(array($_title,$generation,$_session,$_time,$_grade,$_status));
		return $this;
	} 
